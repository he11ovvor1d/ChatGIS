...
if __name__ == '__main__':
    fdir = 'D:\Doc\ChatGIS\model\\'
    model = gensim.models.Word2Vec.load(fdir + 'wiki.zh.text.model')
table_value={
'江苏六合国家地质公园':'POI',"南京江宁汤山国家地质公园":'POI',
"栖霞山国家森林公园":'POI',
"紫金山国家森林公园":'POI',
"南京禄口国际机场":'POI',
"江苏江宁汤山方山国家地质公园":'POI',
"江苏长江新济洲国家湿地公园":'POI',"10号线":'地铁',
"1号线":'地铁',
"2号线":'地铁',
"3号线":'地铁',
"S1号线":'地铁',
...
"河流",
"地铁"]
fun_name={"相交":"st_intersects","包含":"st_intersects","存在":"st_intersects","相邻":"st_touches","穿过":"st_cross"}


# def ismatch(wordlist):
#     for word in wordlist:
#         if not(word in model.wv.key_to_index):
#             print(word,end=',')
# ismatch(table_value.keys())
# print('')
# ismatch(table_name)
# print('')
# ismatch(fun_name.keys())
# print('')



# x=model.wv.most_similar('江苏六合国家地质公园', topn=10)
# for a in x:
#     print(a[0],a[1])
